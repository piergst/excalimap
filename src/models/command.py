...
class Command(MapObject):
    ...
    def draw(self, x, y):
        ...
        calc_width = text_padding + Config.image_width + text_padding + math.ceil(Utils.len_text(self.text) * 8.2)
        ...
        # draw out
        elements, out_end_x, out_end_y = self.draw_out(
            elements, y, center_y, total_size, end_x, end_y, Config.default_out_color
        )
