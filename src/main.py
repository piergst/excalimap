...
def draw(matrix, main_title="", main_title_logo=""):
    ...
    appstate = {"gridSize": 20, "gridStep": 5, "gridModeEnabled": False, "viewBackgroundColor": Config.background_color}
    return json.dumps(
        {
            "type": "excalidraw",
            "version": 2,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-f", "--input_folder", help="folder containing the mindmap .md and conf.yml file", required=True
    )
